...
function WebSocketProxy(url$$1) {
  let self = this;
  EventEmitter.call(this);
  this.sock = new WebSocket(url$$1);
...
var createConnection = function(url$$1) {
  return new WebSocketProxy(url$$1.format({
    protocol: url$$1.protocol,
    slashes: url$$1.slashes,
    host: url$$1.host,
...
Nuid.prototype.setPre = function() {
  var cbuf = crypto_1.randomBytes(preLen);
...
function vueNats(Vue, options) {
  ...
  let nats$$1 = nats.connect(options);
  ...
  Object.defineProperty(Vue.prototype, '$nats', {
    get: function() {
      ...
      return {
        subscribe: function() {
          let sid = nats$$1.subscribe.apply(nats$$1, arguments);
          self.$on('hook:beforeDestroy', function() {
            nats$$1.unsubscribe(sid);
          });
          return sid;
        },
        publish: nats$$1.publish.bind(nats$$1)
